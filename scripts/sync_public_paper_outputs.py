...
# Exact, reviewed aggregate schemas: new columns fail closed before export.
SAFE_SHEET_HEADERS = {
    "Table1_main": ("Route", "Lead (min)", "RN60 CSI-M", "CSI ≥1 mm", "CSI ≥5 mm", "CSI ≥10 mm", "CSI ≥20 mm", "RMSE (mm)", "Mean bias (mm)", "Correlation"),
    "Table1_numeric": ("Route", "Lead (min)", "RN60 CSI-M", "CSI ≥1 mm", "CSI ≥5 mm", "CSI ≥10 mm", "CSI ≥20 mm", "RMSE (mm)", "Mean bias (mm)", "Correlation"),
    "TableS1_training": ("Route / control", "Fitting data", "Selection", "Final members", "Objective / defining change"),
    ...
    "Table1_seed_numeric": ("route", "route_label", "member", "replicate_id", "upstream_seed", "downstream_seed", "lead_min", "csi_m", "rmse", "mean_bias", "correlation", "mae", "finite_pair_count", "csi_1mm", "csi_5mm", "csi_10mm", "csi_20mm"),
    "Gauge_contract_matrix": ("Evaluation setting", "Route / experiment", "Fitting-station targets for fitting or selection", "Held-out-station targets for fitting or selection", "Fitting-station inputs at issuance", "Held-out-station inputs at issuance"),
    ...
    "Fig2d_readout_members": ("route", "replicate", "threshold_mm", "hits", "misses", "false_alarms", "correct_negatives", "csi", "frequency_bias", "finite_pairs"),
    "Fig2d_delta_CI": ("family", "threshold_mm", "delta_csi_mean", "ci_low", "ci_high", "bootstrap_reps", "block", "n_dates", "interval", "seed"),
    "Categorical_per_rep": ("route", "route_label", "member", "replicate_id", "upstream_seed", "downstream_seed", "lead_min", "threshold_mm", "csi", "pod", "far", "frequency_bias", "hit", "miss", "false_alarm", "correct_negative"),
    "Categorical_mean_sd": ("route", "route_label", "lead_min", "threshold_mm", "member_count", "csi_mean", "csi_sd", "pod_mean", "pod_sd", "far_mean", "far_sd", "frequency_bias_mean", "frequency_bias_sd"),
    "Continuous_per_rep": ("route", "route_label", "member", "replicate_id", "upstream_seed", "downstream_seed", "lead_min", "rmse", "mean_bias", "correlation", "mae", "finite_pair_count"),
    "Continuous_mean_sd": ("route", "route_label", "lead_min", "member_count", "rmse_mean", "rmse_sd", "mean_bias_mean", "mean_bias_sd", "correlation_mean", "correlation_sd", "mae_mean", "mae_sd", "finite_pair_count_mean", "finite_pair_count_sd"),
    "Fig3ef_route_contrasts": ("contrast", "left_route", "right_route", "lead_min", "threshold_mm", "left_csi_mean", "right_csi_mean", "delta_csi", "ci_low_pointwise_95", "ci_high_pointwise_95", "bootstrap_fraction_delta_gt_zero", "bootstrap_valid_resamples"),
    "Fig3_macro_contrasts": ("contrast", "left_route", "right_route", "scope", "left_csi_macro", "right_csi_macro", "delta_csi_macro", "ci_low_95", "ci_high_95", "bootstrap_fraction_delta_gt_zero", "bootstrap_valid_resamples"),
    "Fig4a_radar_only": ("panel", "contrast", "left_route", "right_route", "lead_min", "threshold_mm", "left_csi", "right_csi", "delta_csi", "ci_low", "ci_high", "n_finite_common", "bootstrap_reps", "member_count", "member_ids"),
    "Fig4b_no_dropout": ("metric_group", "metric", "contrast", "left_route", "right_route", "lead_min", "threshold_mm", "left_point", "right_point", "delta", "ci_low", "ci_high", "ci_excludes_zero", "bootstrap_valid_reps", "bootstrap_reps", "member_count", "member_ids"),
    ...
    "Fig5_plot_source": ("route", "route_label", "replicate", "aggregation", "lead_min", "metric", "x_index", "x_label", "bin_low_mm", "bin_high_mm", "threshold_mm", "estimate", "ci_low", "ci_high", "n_common_pairs", "n_observed_events"),
    "Fig5_amount": ("route", "route_label", "lead_min", "gauge_bin", "amount_bias_mm_mean", "amount_bias_mm_sd", "n_common_pairs"),
    "Fig5_frequency": ("route", "route_label", "lead_min", "threshold_mm", "frequency_bias_mean", "frequency_bias_sd", "n_observed_events"),
    "Case_per_rep": ("case_rank", "event_label", "lead_min", "threshold_mm", "route", "route_label", "member", "replicate_id", "upstream_seed", "downstream_seed", "hit", "miss", "false_alarm", "correct_negative", "finite_pair_count", "n_issue_times", "csi"),
    "Case_mean_sd": ("case_rank", "event_label", "lead_min", "threshold_mm", "route", "route_label", "member_count", "csi_mean", "csi_sd", "csi_min", "csi_max", "finite_pair_count", "n_issue_times"),
    "FigS3_pairwise_counts": ("threshold_mm", "comparison", "stations_left_higher", "stations_equal", "stations_left_lower", "stations_total", "mean_stationwise_csi_difference", "median_stationwise_csi_difference"),
...
SAFE_REFERENCE_ASSETS = {
    ...
    "11_Table_1_heldout_point_skill.png": "table1_heldout_point_skill.png",
}
